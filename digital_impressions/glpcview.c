...
static int color = 1;          // Use the RGB texture or just draw it as color
...
static void no_kinect_quit(void)
{
...
int main_glpcview(int argc, char **argv)
{
    //glutInit(&argc, argv);
    ...
    window = glutCreateWindow("xbox + glpcivew");
